      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-14 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1.4fr] gap-10 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { name: 'OreBill AI™',          href: '/product/orebill-ai',           color: '#ff851b' },
                { name: 'EdgeBay Intelligence',  href: '/product/edgebay-intelligence', color: '#1e90ff' },
                { name: 'SecureCloud',           href: '/product/securecloud',          color: '#5e17ea' },
                { name: 'iPaS-RevOps',           href: '/product/ipas-revops',          color: '#0ea5e9' },
                { name: 'MedicsIQ',              href: '/product/medicsiq',             color: '#22c55e' },
              ].map((p) => (
                <li key={p.name}>
                  <Link
                    href={p.href}
